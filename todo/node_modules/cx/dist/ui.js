...
var Instance =
	...
	(function() {
		...
		_proto.markShouldUpdate = function markShouldUpdate(context) {
			...
			var startIndices; //notify all parents that child state change to bust up caching
		...
		_proto.explore = function explore(context) {
			...
			this.widget.explore(context, this, this.data); //because tree exploration uses depth-first search using a stack,
...
var RenderingContext =
	...
	(function() {
		...
		_proto.getCurrentRenderList = function getCurrentRenderList() {
			return this.renderLists[this.renderListIndex];
		};

		_proto.insertRenderList = function insertRenderList() {
		...
		_proto.getPrevRenderList = function getPrevRenderList() {
		...
		_proto.getNextRenderList = function getNextRenderList() {
			this.renderListIndex++;
		...
		_proto.getRenderLists = function getRenderLists() {
			var result = [];
	...
	(function(_VDOM$Component2) {
		...
		_proto2.componentWillReceiveProps = function componentWillReceiveProps(props) {
			...
			if (visible) {
				...
				this.timings.afterPrepare = now(); //console.log(context.prepareList);
	...
	(function(_PureContainer2) {
		...
		_proto2.explore = function explore(context, instance) {
			...
			for (var i = this.items.length - 1; i >= 0; i--) {
				var x = instance.getChild(context, this.items[i]);
